//CODE FROM: https://github.com/benoitvallon/computer-science-in-javascript

class Graph {
  constructor() {
    //Have one array tracking each vertex, and another array (called edges) that tracks all the neighbors for a given vertex.
